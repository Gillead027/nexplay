...
| Lista de membros do servidor (por cargo, por presença) | `PARTIAL` (commits `e1027d3` e `8460085`, em produção): **Online em cima e Offline embaixo**, ao vivo, com avatar, bolinha, status e clique para o perfil, na tela de voz. Faltam: mostrar em canal de texto, agrupar por cargo e cor de cargo |
